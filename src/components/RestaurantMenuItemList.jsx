...
function RestaurantMenuItemList({ items }) {
  return (
    <div>
      {items.map((item) => (
        <div
        ...
        >
          ...
          <div className="w-32 relative">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-0.1 p-6">
              <div>
                <button className="relative px-6 py-2 border border-gray-300 rounded-md text-xs bg-white text-green-500 whitespace-nowrap">
                  ADD
                </button>
              </div>
            </div>
